...
print('Você poderá viajar? ', (possui_passaporte == True and passagem_comprada == True) and (not menor_de_idade))
print('Você poderá viajar? ', (possui_passaporte == True or passagem_comprada == True) and (not menor_de_idade))
print('Você poderá viajar? ', (not possui_passaporte or passagem_comprada) and (not menor_de_idade))
print('Você poderá viajar? ', (not possui_passaporte or not passagem_comprada) and (not menor_de_idade))